...
\caption{End-to-end architecture used in this thesis: frozen Wav2Vec~2.0 and BERT-family encoders produce acoustic and textual sequences, which are placed on a common index by the alignment step, combined by the sequence-to-sequence fusion module, and mapped to a task label by a shallow head.}
